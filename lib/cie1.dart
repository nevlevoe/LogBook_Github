...
class Cie1 extends StatefulWidget {
  ...
  @override
  _Cie1State createState() => _Cie1State();
}
...
class _Cie1State extends State<Cie1> {
  ...
  Future<void> _fetchStudents() async {
    ...
    for (var doc in studentMarksSnapshot.docs) {
      ...
      students.add({
        ...
        'documentID': doc.id,
        'cie1': doc['CIE1'],
        'controller': TextEditingController(text: doc['CIE1'].toString())
      });
    }
  ...
  Future<void> _submitMarks() async {
    ...
    for (var student in _students) {
      await FirebaseFirestore.instance
          ...
          .update({'CIE1': student['controller'].text});
    }
  ...
  Widget build(BuildContext context) {
    print('Building Cie1 widget with ${_students.length} students');
    return Scaffold(
      appBar: AppBar(
