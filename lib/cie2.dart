...
class Cie2 extends StatefulWidget {
  ...
  @override
  _Cie2State createState() => _Cie2State();
}
...
class _Cie2State extends State<Cie2> {
  ...
  Future<void> _fetchStudents() async {
    ...
    for (var doc in studentMarksSnapshot.docs) {
      ...
      students.add({
        ...
        'documentID': doc.id,
        'cie2': doc['CIE2'],
        'controller': TextEditingController(text: doc['CIE2'].toString())
      });
    }
  ...
  Future<void> _submitMarks() async {
    ...
    for (var student in _students) {
      await FirebaseFirestore.instance
          ...
          .update({'CIE2': student['controller'].text});
    }
  ...
  Widget build(BuildContext context) {
    print('Building Cie2 widget with ${_students.length} students');
    return Scaffold(
      appBar: AppBar(
