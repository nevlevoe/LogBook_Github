...
class _PracticalsState extends State<Practicals> {
  ...
  Future<void> _fetchStudents() async {
    ...
    for (var doc in studentMarksSnapshot.docs) {
      ...
      students.add({
        ...
        'controller': TextEditingController(text: doc['Practicals'].toString())
      });
    }
  ...
  Future<void> _submitMarks() async {
    ...
    for (var student in _students) {
      await FirebaseFirestore.instance
          ...
          .update({'Practicals': student['controller'].text});
    }
  ...
  Widget build(BuildContext context) {
    print('Building Practicals widget with ${_students.length} students');
    return Scaffold(
      appBar: AppBar(
